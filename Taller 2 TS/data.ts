...
export const series = [
    ...
    new Serie(
        ...
        "./images/OrangeIstheNewBlack.jpg"
    ),
    new Serie(
        3, "Game of Thrones", "HBO", 7,
        "American fantasy drama, the series is an adaptation of A Song of Ice and Fire, George R. R. Martin's series of fantasy novels.",
    ...
    new Serie(
        6, "A Very English Scandal", "BBC", 2,
        ...
        "./images/AVeryEnglishScandal.jpg"
    )
];
